...
def main():
    # 输入小说文件路径和输出文件夹路径
    novel_file = "./3Dreame/虐文女主她翻身了/completed/"  # 中文小说文件路径
    output_folder =  "./3Dreame/虐文女主她翻身了/edit_ok/"  # 输出文件夹路径
